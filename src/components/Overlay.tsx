...
export function Overlay(props: IOverlayProps) {
    ...
    const spread = cn(remain, { 'hidden pointer-events-none': !open, 'pointer-events-auto': open }, 'flex p-6 w-full h-full')();
    return createPortal(
        <div {...spread}>
            <div className='flex relative w-full h-full bg-black/70 border-white/70 rounded-lg text-white'>
